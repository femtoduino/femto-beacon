...
/******************************************************************************
                   Types section
******************************************************************************/
typedef void (* AccessPoint_t)(void);

/******************************************************************************
                   Prototypes section
******************************************************************************/
#if defined(__ICCAVR__)
_Pragma("location=\"RF4CE_SECT\"") static void flash_fill_page_buffer(fill_page_buffer_req_t *param);
_Pragma("location=\"RF4CE_SECT\"") static void flash_program_page(program_page_req_t *param);
_Pragma("location=\"RF4CE_SECT\"") __noreturn static void flash_swap(swap_images_req_t *param);
_Pragma("location=\"RF4CE_SECT\"") static void flash_boot_request_handler(void);
_Pragma("location=\"RF4CE_SECT\"") static void flash_erase_page(erase_page_req_t *param);
_Pragma("location=\"RF4CE_SECT\"") static void flash_write_page(write_page_req_t *param);
...
******************************************************************************/
#if defined(__ICCAVR__)
__root const __farflash AccessPoint_t access_point @ (FLASHEND + 1ul - sizeof(AccessPoint_t)) = flash_boot_request_handler;
#elif defined(__GNUC__)
__attribute__((section(".access_sect"))) AccessPoint_t access_point = flash_boot_request_handler;
#ifdef ATMEGA256RFR2
__attribute__((section(".far_addr_padding_sect"))) uint8_t padding = 0x01;
#endif
#endif
/******************************************************************************
...
******************************************************************************/
#ifndef DISABLE_FLASH_SWAP_RF4CE_FUNCTION
...
#endif // DISABLE_FLASH_SWAP_RF4CE_FUNCTION
