...
#define ACTION_POSITION              0
  ...
  #if !defined(ATXMEGA256A3) && !defined(ATMEGA256RFR2)
    #error 'at25df041a is supported only for atxmega256a3, atmega256rfr2.'
  #endif
  ...
  #define EXT_FLASH_START_ADDRESS                          0
    ...
    // image consists mcu flash size - boot section size. 256k - 4k
    #define MCU_FLASH_SIZE                            258048
    #define MCU_EEPROM_SIZE                             8192
  #elif defined(ATXMEGA256A3)
    #define MCU_FLASH_SIZE                            262144
    #define MCU_EEPROM_SIZE                             4096
  #endif
  #define IMAGE_SIZE                 (MCU_FLASH_SIZE + MCU_EEPROM_SIZE)
